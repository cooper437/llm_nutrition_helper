...
def extract_calories(food_nutrients: list) -> int:
    """Extracts the calories from the foodNutrients list"""
...
def extract_carbs(food_nutrients: list) -> int:
    """Extracts the carbs from the foodNutrients list"""
...
def extract_fat(food_nutrients: list) -> int:
    """Extracts the fat from the foodNutrients list"""
...
def extract_protein(food_nutrients: list) -> int:
    """Extracts the protein from the foodNutrients list"""
...
def parse_foundation_ingredients_nutrition_df():
    """Parses the foundation food ingredients and nutrition data into a dataframe"""
